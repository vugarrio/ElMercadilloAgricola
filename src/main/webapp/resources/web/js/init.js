...
================================================== */
	MERCADILLO.ContactForm = function(){
...
/* ==================================================
	Scroll to Top
================================================== */
	MERCADILLO.scrollToTop = function(){
...
/* ==================================================
   Twitter Widget
================================================== */
	MERCADILLO.TwitterWidget = function() {
...
/* ==================================================
   Flex Slider
================================================== */
	MERCADILLO.galleryflex = function() {
...
/* ==================================================
   Owl Carousel
================================================== */
	MERCADILLO.OwlCarousel = function() {
...
/* ==================================================
   PrettyPhoto
================================================== */
	MERCADILLO.PrettyPhoto = function() {
...
/* ==================================================
   Header Functions
================================================== */
	MERCADILLO.StickyHeader = function() {
...
/* ==================================================
	Responsive Nav Menu
================================================== */
	MERCADILLO.MobileMenu = function() {
...
================================================== */
	var $tallestCol;
	MERCADILLO.pricingTable = function(){
...
$(document).ready(function(){
	MERCADILLO.ContactForm();
	MERCADILLO.scrollToTop();
	MERCADILLO.accordion();
	MERCADILLO.toggle();
	MERCADILLO.toolTip();
	MERCADILLO.TwitterWidget();
	MERCADILLO.galleryflex();
	MERCADILLO.OwlCarousel();
	MERCADILLO.PrettyPhoto();
	MERCADILLO.SuperFish();
	MERCADILLO.Counters();
	MERCADILLO.IsoTope();
	MERCADILLO.StickyHeader();
	MERCADILLO.heroflex();
	MERCADILLO.Password();
	MERCADILLO.pricingTable();
	MERCADILLO.MobileMenu();
...
$(document).ready(function(){
	...
	$('.search-advanced-trigger').on("click", function() {	
		if ($(this).hasClass('advanced')) {
			...
			$(this).html('Búsqueda avanzada <i class="fa fa-arrow-down"></i>');
		} else {			
			$(this).addClass('advanced');
                        $(".advanced-search-row").slideDown();
			$(this).html('Búsqueda avanzada <i class="fa fa-arrow-up"></i>');
...
function mostrarCajaFormMensajeError (obj, txt) {
...
function mostrarCajaFormMensajeOK (obj, txt) {
    var mensaje = '<div class="alert alert-success alert-dismissible" role="alert">';
    mensaje += txt;
    mensaje += '</div>';
