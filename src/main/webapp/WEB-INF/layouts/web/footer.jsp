       		...
       		<div class="container">
                <div class="row">
                	...
                	<div class="col-md-2 col-sm-6 footer_widget widget widget_custom_menu widget_links">
                        ...
                        <ul>
                        	<li><a href="anuncios.jsp?f_idcategoria=1">Tractores</a></li>
                        	<li><a href="anuncios.jsp?f_idcategoria=2">Cosechadoras</a></li>
                        	<li><a href="anuncios.jsp?f_idcategoria=3">Sembradoras</a></li>
                        	<li><a href="anuncios.jsp?f_idcategoria=5">Aperos</a></li>
                        </ul>
                    </div>
                	<div class="col-md-2 col-sm-6 footer_widget widget widget_custom_menu widget_links">
