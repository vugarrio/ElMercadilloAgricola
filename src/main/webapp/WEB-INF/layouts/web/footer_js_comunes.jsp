...
<script src="${pageContext.servletContext.contextPath}/resources/web/js/ui-plugins.js"></script> <!-- UI Plugins -->
<script src="${pageContext.servletContext.contextPath}/resources/web/js/helper-plugins.js"></script> <!-- Helper Plugins -->
...
--%>
        <script src="${pageContext.servletContext.contextPath}/resources/web/js/login.js"></script>
<%--
    }
--%> 